    ...
    GstPadProbeInfo * info, gpointer u_data)
{
  ...
  for (l_frame = batch_meta->frame_meta_list; l_frame != NULL; l_frame = l_frame->next) {
    ...
    if (srcInfo == NULL || srcInfo->config == NULL || !gst_pad_is_linked(srcInfo->uribin_src_pad) || !srcInfo->muxSinkPad || !srcInfo->uribin_src_pad || !srcInfo->uribin)  {
        continue;
    }
